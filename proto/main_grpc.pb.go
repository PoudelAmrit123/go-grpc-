...
type GreetServiceClient interface {
	...
	SayHelloServerStreamning(ctx context.Context, in *NameList, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamningClient, error)
...
func (c *greetServiceClient) SayHelloServerStreamning(ctx context.Context, in *NameList, opts ...grpc.CallOption) (GreetService_SayHelloServerStreamningClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[0], "/greet_service.GreetService/SayHelloServerStreamning", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceSayHelloServerStreamningClient{stream}
...
type GreetService_SayHelloServerStreamningClient interface {
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type greetServiceSayHelloServerStreamningClient struct {
	grpc.ClientStream
}

func (x *greetServiceSayHelloServerStreamningClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
...
type GreetServiceServer interface {
	...
	SayHelloServerStreamning(*NameList, GreetService_SayHelloServerStreamningServer) error
...
func (UnimplementedGreetServiceServer) SayHelloServerStreamning(*NameList, GreetService_SayHelloServerStreamningServer) error {
	return status.Errorf(codes.Unimplemented, "method SayHelloServerStreamning not implemented")
}
...
func _GreetService_SayHelloServerStreamning_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(NameList)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(GreetServiceServer).SayHelloServerStreamning(m, &greetServiceSayHelloServerStreamningServer{stream})
}

type GreetService_SayHelloServerStreamningServer interface {
	Send(*HelloResponse) error
	grpc.ServerStream
}

type greetServiceSayHelloServerStreamningServer struct {
	grpc.ServerStream
}

func (x *greetServiceSayHelloServerStreamningServer) Send(m *HelloResponse) error {
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "SayHelloServerStreamning",
			Handler:       _GreetService_SayHelloServerStreamning_Handler,
			ServerStreams: true,
		},
		{
